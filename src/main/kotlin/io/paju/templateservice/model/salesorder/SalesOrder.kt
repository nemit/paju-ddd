...
class SalesOrder internal constructor(internal val customer: CustomerId,
                                      ...
                                      internal val id: SalesOrderId = SalesOrderId(UUID.randomUUID()),
                                      internal val unitOfWork: UnitOfWork = UnitOfWork()) {
